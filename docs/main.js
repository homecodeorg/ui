...
*/
var aa=__webpack_require__("./node_modules/react/index.js"),ba=__webpack_require__("./node_modules/scheduler/index.js");function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b)}
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("6caad5dabdc4d036d3c5")
/******/ 	})();
/******/ 	
...
var App_App_App = (_dec = (0,justorm_react.withStore)('app'), _dec(_class = /*#__PURE__*/function (_Component) {
  ...
  (0,createClass/* default */.Z)(App, [{
    ...
    value: function render() {
      ...
      }, "v", "3.0.0"), /*#__PURE__*/App_React.createElement(Button/* Button */.z, {
