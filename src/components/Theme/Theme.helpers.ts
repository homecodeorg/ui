...
export function mixColor(color1: string, color2: string, val: number = 1) {
...
type ColorConfig = string | { color: string; mods: ColorMods };
type ColorsConfig = { [name: string]: ColorConfig };
