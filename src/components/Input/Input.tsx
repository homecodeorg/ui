...
class Input extends Component<T.Props> {
    ...
    return (
      <div className={classes}>
        ...
        <label className={S.main} key="main">
          ...
          {adornmentLeft && (
            <div
              className={S.adornmentLeft}
              key="ad-left"
              title={adornmentLeft}
            >
              <span>{adornmentLeft}</span>
            </div>
          )}
          <Control
            className={S.control}
          ...
          {adornmentRight && (
            <div
              className={cn(S.adornmentRight, adornmentRightClassName)}
              key="ad-right"
              title={adornmentRight}
            >
              <span>{adornmentRight}</span>
            </div>
          )}
          {this.renderLabel()}
          {required && (
        ...
        {!disabled && typeof error === 'string' && (
          <AssistiveText variant="error" size={size}>
            {error}
          </AssistiveText>
        )}
      </div>
...
export type ControlProps = T.Props;
